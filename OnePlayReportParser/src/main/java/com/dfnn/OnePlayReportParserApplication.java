...
@Slf4j
public class OnePlayReportParserApplication {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OnePlayReportParserApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(OnePlayReportParserApplication.class, args);
