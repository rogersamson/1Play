...
@Slf4j
public class ProgressiveJackpotApplication {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ProgressiveJackpotApplication.class);


	public static void main(String[] args) {
		SpringApplication.run(ProgressiveJackpotApplication.class, args);
